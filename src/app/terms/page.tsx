    ...
    <div className="min-h-screen bg-gray-50 font-body">
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <h1 className="text-3xl font-bold text-gray-800 font-headline">Terms of Service</h1>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-lg">
          <div className="space-y-6 text-gray-700">
            ...
            <div>
              <h2 className="font-bold text-2xl mt-6 mb-3 font-headline text-gray-800">1. Introduction</h2>
            ...
            <div>
              <h2 className="font-bold text-2xl mt-6 mb-3 font-headline text-gray-800">2. Accounts</h2>
              <p className="leading-relaxed">
            ...
            <div>
              <h2 className="font-bold text-2xl mt-6 mb-3 font-headline text-gray-800">3. User Data</h2>
              <p className="leading-relaxed">
            ...
            <div>
              <h2 className="font-bold text-2xl mt-6 mb-3 font-headline text-gray-800">4. Termination</h2>
              <p className="leading-relaxed">
            ...
            <div>
              <h2 className="font-bold text-2xl mt-6 mb-3 font-headline text-gray-800">5. Governing Law</h2>
              <p className="leading-relaxed">
            ...
            <div>
              <h2 className="font-bold text-2xl mt-6 mb-3 font-headline text-gray-800">6. Changes</h2>
              <p className="leading-relaxed">
            ...
            <div>
              <h2 className="font-bold text-2xl mt-6 mb-3 font-headline text-gray-800">7. Contact Us</h2>
              <p className="leading-relaxed">
